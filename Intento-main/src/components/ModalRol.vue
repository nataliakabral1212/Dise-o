...
watch(() => props.show, (val) => {
  if (val) {
    form.value = props.action === 'editar' && props.rol
      ? { nombre: props.rol.nombre, descripcion: props.rol.descripcion, estado: props.rol.estado }
        ...
        <div style="position:relative;background:white;border-radius:24px;padding:36px;width:100%;max-width:460px;box-shadow:0 24px 60px rgba(122,78,56,0.18);font-family:'Jost',sans-serif;">
          ...
          <div style="display:flex;flex-direction:column;gap:16px;">
            ...
            <div>
              ...
              <input v-model="form.nombre" type="text" placeholder="Ej. Administrador" :style="inputStyle"
            ...
            <div>
              ...
              <textarea v-model="form.descripcion" placeholder="Describe el rol..." rows="3"
    ...
    <Transition name="fade">
      <div v-if="showDelete"
        ...
        <div style="position:relative;background:white;border-radius:24px;padding:36px;width:100%;max-width:400px;box-shadow:0 24px 60px rgba(122,78,56,0.18);font-family:'Jost',sans-serif;text-align:center;">
          ...
          <h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-size:22px;font-weight:700;color:#7A4E38;margin:0 0 8px;">Eliminar Rol</h3>
          <p style="font-size:13px;color:#A896A0;margin:0 0 28px;">
            ¿Estás seguro de eliminar <strong style="color:#7A4E38;">{{ rolAEliminar?.nombre }}</strong>? Esta acción no se puede deshacer.
          </p>
